...
st.sidebar.image(
    'src/utils/streamlit/images/800px-IMDB_Logo_2016.svg.png', width=200)
...
menu = st.sidebar.radio(
    "",
    ("Intro", "Data", "Variables de estudio", 'Otras variables',
     "Relaciones entre variables", "Matrices de correlación"),
)
...
st.sidebar.markdown('---')
st.sidebar.write(
    'Ana Blanco | Julio 2021 anablancodelgado@gmail.com https://casiopa.github.io/')
